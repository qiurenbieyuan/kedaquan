...
import com.yangs.kedaquan.bbs.BBSDetailActivity;
import com.yangs.kedaquan.bbs.BBSReplyActivity;
...
public class BBSFragment extends LazyLoadFragment implements OnItemClickListener, OnItemLongClickListener, OnRefreshListener, View.OnClickListener,
    ...
    private void initView() {
        ...
        toolbar = mLay.findViewById(R.id.bbs_toolbar);
        toolbar.setTitle("");
        ((AppCompatActivity) getActivity()).setSupportActionBar(toolbar);
        toolbar.setOnMenuItemClickListener(this);
        url = "http://www.myangs.com:81/forum.php?mod=forumdisplay&fid=46&mobile=1";
        list = new ArrayList<>();
        lRecyclerView = mLay.findViewById(R.id.articlefragment_lr);
