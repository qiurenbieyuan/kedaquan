...
public class ScoreActivity extends Activity implements OnItemClickListener, OnRefreshListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        lRecyclerView = (LRecyclerView) findViewById(R.id.score_lr);
        ...
        final String[] datalist = new String[4];
        ...
        header_view_bt = (TextView) header_view.findViewById(R.id.score_header_bt);
        header_view_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(ScoreActivity.this).setTitle("选择学期")
                        .setSingleChoiceItems(datalist, 3, new DialogInterface.OnClickListener() {
                            @Override
