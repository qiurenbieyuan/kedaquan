...
public class VpnSource {
    ...
    public int checkVpnUser() {
        ...
        try {
            ...
            if (location.contains("welcome.cgi?p=user-confirm")) {
    ...
    public int checkJwUser(String jw_user, String jw_pwd) {
        ...
        RequestBody requestBody = formBodyBuilder.build();
        Request request = new Request.Builder().url("https://vpn.just.edu.cn/jsxsd/xk/,DanaInfo=jwgl.just.edu.cn,Port=8080+LoginToXk")
